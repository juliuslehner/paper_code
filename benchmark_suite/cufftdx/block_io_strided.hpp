...
namespace example {
    ...
    struct io_strided: public io<FFT> {
        ...
        // Add Half function for load_strided
        template<bool InputInRRIILayout = false, unsigned int Stride, unsigned int Batches = Stride>
        static inline __device__ void load_strided_half(const cufftdx::complex<__half2>* input,
        ...
        // Add half function for store_strided
        template<bool OutputInRRIILayout = false, unsigned int Stride, unsigned int Batches = Stride>
        static inline __device__ void store_strided_half(const cufftdx::complex<__half2>* thread_data,
